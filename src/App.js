...
const App = () => {
  ...
  return (
    <div>
      <center>
        <h1>Ramana's Gallery</h1><br></br>
        <form onSubmit={submitHandler}>
          <input size="30" height="5" type="text" onChange={changeHandler} value={search}/><br /><br />
          <input type="submit" name="Search" />
        </form>
        <br />
        {data.length>=1?<Gallery data={data}/>:<h3>No Image Loaded</h3>}
      </center>
    </div>
  )
}
